...
function dibujoCChart(theme){
  ...
  // lienzoCChart.clearRect(0,0,maxX, maxY);  
  ...
  // lienzoCChart.clearRect(0,0,maxX, maxY);  
  // lienzoCChart.strokeText("INGENIOSO 23%", iX(-5.6), iY(2.2));
  // lienzoCChart.strokeText("realizar aquello que hemos ideado", iX(-7.5), iY(1.6));
  // lienzoCChart.strokeText("de forma creativa para volverlo", iX(-7.5), iY(1.2));
  // lienzoCChart.strokeText("realidad", iX(-5), iY(0.8));
 }
